      ...
      <table className="w-full border-collapse">
        <tbody>
          <tr className="border-b border-gray-200">
            <td className="py-4 pr-6 border-r border-gray-200 align-top font-semibold text-gray-500 w-28 text-lg">
              2022-07&nbsp;to 2026-03
            </td>
          ...
          <tr className="border-b border-gray-200">
            ...
            <td className="py-4 pl-6 align-top">
              ...
              <div className="mt-8">
                ...
                <ul className="list-disc pl-5 mt-1 space-y-1">
                  <li>
                    I set up a work process between several ex-Piggy employees
                    so we could deliver several big features on time.
                  </li>
                  <li>
                    I led the process of evaluating and promoting two junior
                    employees. I designed and fully led the learning course for
                    them, so they could catch up in terms of experience with
          ...
          <tr className="border-b border-gray-200">
            ...
            <td className="py-4 pl-6 align-top">
              ...
              <div className="mt-2">
                I was working as a <strong>front end technical leader</strong>{" "}
                in a group of teams developing different modules of an internal
                delivery mobile application. I helped all JavaScript developers
                in the group to be in sync in terms of our infrastructure,
                standards and technical debt. I also contributed to the company
                subdivision infrastructure, processes and documentation.
              </div>
              <div className="mt-2">
                <strong className="block">My key accomplishments:</strong>
                <ul className="list-disc pl-5 mt-1 space-y-1">
          ...
          <tr className="border-b border-gray-200">
            ...
            <td className="py-4 pl-6 align-top">
              ...
              <div className="mt-2">
                ...
                internal credit cards delivery{" "}
              ...
              <div className="mt-2">
                ...
                <ul className="list-disc pl-5 mt-1 space-y-1">
                  <li>
                    I&apos;ve <strong>redesigned</strong> our application form
                    UI when we had no dedicated visual designer.
                  </li>
                  <li>
                    I&apos;ve <strong>refactored</strong> the entire project
                    during my work in a team which made it much more scalable
                    and sped up new features delivery.
                  </li>
                  <li>
          ...
          <tr className="border-b border-gray-200">
            ...
            <td className="py-4 pl-6 align-top">
              ...
              <div className="mt-2">
                ...
                <strong>a book library</strong> website for SKB Contour
                employees and{" "}
                <strong>
              ...
              <div className="mt-2">
                ...
                <ul className="list-disc pl-5 mt-1 space-y-1">
                  ...
                  <li>
                    I&apos;ve written a mercurial{" "}
                    <strong>pre-commit hook</strong> to help back end
          ...
          <tr className="border-b border-gray-200">
            ...
            <td className="py-4 pl-6 align-top">
              ...
              <div className="mt-2">
                I&apos;ve developed a <strong>CMS website</strong> for a
                gymnasium from conception. Its features include rich UI SPA, a
                database and a REST API. It was my first experience with
                webpack+React together with REST API (Java, spring-boot).
              </div>
              ...
              <div className="mt-2">
                ...
                <ul className="list-disc pl-5 mt-1 space-y-1">
                  ...
                  <li>
                    A <strong>CI</strong> to quickly deliver the project to a
                    test environment.
                  </li>
                  <li>
          ...
          <tr>
            ...
            <td className="py-4 pl-6 align-top">
              ...
              <div className="mt-2">
                I worked as a junior front-end developer in a big team
                maintaining a accounting web service. I participated in several
                projects such as Personal Profile page and a large Requisites
                form for company clients.
              </div>
              <div className="mt-2">
                <strong className="block">My key accomplishments:</strong>
                <ul className="list-disc pl-5 mt-1 space-y-1">
